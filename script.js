  ...
  setTimeout(() => {
    ...
    for(let i in searchList) {
      ...
      if(i.indexOf(value) + 1)
        list.innerHTML += '<li class="op-item" title="'+desc+'"><span class="code">'+stringify(searchList[i], 2, true)+'</span><span class="instruction">'+i+'</span><span class="info" data-desc="'+desc+'" tabindex="0">&#8505;</span></li>';
    }
